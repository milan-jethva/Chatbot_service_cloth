...
products_ref = db.collection("faqs")
...
for doc in docs:
    ...
    text_to_embed = product_data.get("question", "") + " " + product_data.get("answer", "")
    ...
    print(f"✅ Updated embedding for product: {product_data.get('question')}")
